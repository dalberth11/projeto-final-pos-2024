...
SECRET_KEY = 'django-insecure-)u^9xs5bq!eku5+!6k1*cyep#y=9@dg#1-#*mqlyfg@!x$q@*t'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Diretório onde você armazena os arquivos estáticos durante o desenvolvimento
]